        ...
        <div class="wrapper">
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="<?php echo e(route('logout')); ?>" onclick="return confirm('Yakin ingin logout')" class="nav-link">
                            Logout
                        </a>
                    </li>
                </ul>
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a style="color: #fff;" href="<?php echo e(route('home')); ?>" class="nav-link <?php echo e(str_contains(Request::path(), 'user') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a style="color: #fff;" href="<?php echo e(route('machine')); ?>" class="nav-link <?php echo e(str_contains(Request::path(), 'machine') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-tachometer-alt"></i>
                                    <p>
                                        Machine
                                    </p>
                            ...
                            <li class="nav-item">
                                <a style="color: #fff;" href="<?php echo e(route('machine-logs')); ?>" class="nav-link <?php echo e(str_contains(Request::path(), 'logs') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-tachometer-alt"></i>
                                    <p>
                                        Machine Logs
                                    </p>
...
<?php /**PATH /www/wwwroot/103.171.85.186/terapan-backend/resources/views/template.blade.php ENDPATH**/ ?>